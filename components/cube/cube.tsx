...
export default function Cube() {
  ...
  return (
    <>
      ...
      <div id="ribbon">
        <div className="btn" id="random">Random</div>
        <div className="btn" id="reset">Reset</div>
      </div>


      <a id="fork-me" href="https://github.com/Aaron-Bird/rubiks-cube">
        <img width="149" height="149" src="./img/forkme_right_gray_6d6d6d.png" className="attachment-full size-full"
